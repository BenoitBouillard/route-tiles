    ...
    { // MODE
        $('a.dropdown-item').on('click', function(e) {
            if ($(this).data('mode') != $('#mode-selection').data('mode')) {
                ...
                $('#mode-selection').text($(this).text());
                localStorage.setItem('mode', $(this).data('mode'));
                localStorage.setItem('mode-selection', $(this).text());
                request_route();
            }
        });
        let lms = localStorage.getItem('mode-selection')
        let lmd = localStorage.getItem('mode')
        if (lms && lmd) {
            $('#mode-selection').text(lms);
